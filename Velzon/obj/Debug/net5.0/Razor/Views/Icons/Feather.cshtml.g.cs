#pragma checksum "C:\Users\Vishal\Desktop\asp.net\Modern\Modern\Velzon\Views\Icons\Feather.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c356b3931e653f73063b401282cdebba4557ab36"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Icons_Feather), @"mvc.1.0.view", @"/Views/Icons/Feather.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c356b3931e653f73063b401282cdebba4557ab36", @"/Views/Icons/Feather.cshtml")]
    ...
    #nullable restore
    public class Views_Icons_Feather : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    #nullable disable
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\Vishal\Desktop\asp.net\Modern\Modern\Velzon\Views\Icons\Feather.cshtml"
  
    ViewBag.Title = "Feather Icons";
    ViewBag.pTitle = "Feather Icons";
...
");
            ...
            WriteLiteral(@"                      <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                ");
            WriteLiteral(@"                <i data-feather=""aperture""></i> aperture
                                            </div>
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
        ...
        ");
            ...
            WriteLiteral(@"                      <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
      ");
            WriteLiteral(@"                                          <i data-feather=""arrow-up""></i> arrow-up
                                            </div>
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"              </div>
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
        ");
            WriteLiteral(@"                                        <i data-feather=""camera""></i> camera
                                            </div>
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"-3 col-lg-4 col-sm-6"">
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                                <i");
            WriteLiteral(@" data-feather=""chrome""></i> chrome
                                            </div>
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"                      <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        ");
            WriteLiteral(@"                        <i data-feather=""cloud""></i> cloud
                                            </div>
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
        ...
        ");
            WriteLiteral(@"                                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                                ");
            WriteLiteral(@"<i data-feather=""corner-down-left""></i> corner-down-left
                                            </div>
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                                <i data-feather=""corner-right-down""></i> corner-ri");
            WriteLiteral(@"ght-down
                                            </div>
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"                        <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                              ");
            WriteLiteral(@"  <i data-feather=""delete""></i> delete
                                            </div>
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"                                <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ");
            WriteLiteral(@"                            <i data-feather=""droplet""></i> droplet
                                            </div>
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                            ");
            WriteLiteral(@"                    <i data-feather=""feather""></i> feather
                                            </div>
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                                <i d");
            WriteLiteral(@"ata-feather=""folder-minus""></i> folder-minus
                                            </div>
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"                      <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                              ");
            WriteLiteral(@"  <i data-feather=""git-pull-request""></i> git-pull-request
                                            </div>
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"                      <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                                <i dat");
            WriteLiteral(@"a-feather=""help-circle""></i> help-circle
                                            </div>
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
...
");
            ...
            WriteLiteral(@"          </div>
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                              ");
            WriteLiteral(@"                  <i data-feather=""maximize-2""></i> maximize-2
                                            </div>
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
  ...
  ");
            WriteLiteral(@"                                          <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        ");
            WriteLiteral(@"                        <i data-feather=""minimize""></i> minimize
                                            </div>
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"                      <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                          ");
            WriteLiteral(@"      <i data-feather=""plus-square""></i> plus-square
                                            </div>
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"                  <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                                                <i d");
            WriteLiteral(@"ata-feather=""rewind""></i> rewind
                                            </div>
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"              </div>
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                  ");
            WriteLiteral(@"                              <i data-feather=""x-square""></i> x-square
                                            </div>
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
       ...
       ");
          ...
          ");
            ...
            WriteLiteral(@"
                                            ...
                                            <div class=""col-xl-3 col-lg-4 col-sm-6"">
");
            WriteLiteral(@"                                                <i data-feather=""clock"" class=""icon-dual-secondary""></i> clock
                                            </div>
...
");
            DefineSection("scripts", async() => {
                WriteLiteral("\r\n    \r\n    <!-- App js -->\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c356b3931e653f73063b401282cdebba4557ab3679818", async() => {
                }
                );
