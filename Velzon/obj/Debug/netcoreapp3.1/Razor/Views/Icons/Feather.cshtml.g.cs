#pragma checksum "C:\Projects\raju\velzon\Velzon_asp_core\Velzon\Velzon\Views\Icons\Feather.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8acd3bacb7c7debf6de0f3674afad5ecc26b2837"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8acd3bacb7c7debf6de0f3674afad5ecc26b2837", @"/Views/Icons/Feather.cshtml")]
    ...
    public class Views_Icons_Feather : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Projects\raju\velzon\Velzon_asp_core\Velzon\Velzon\Views\Icons\Feather.cshtml"
...
<div class=""row"">
    <div class=""col-12"">
        <div class=""card"">
            ...
            WriteLiteral(@"-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                       ");
            WriteLiteral(@" <i data-feather=""arrow-left-circle""></i> arrow-left-circle
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i data-feather");
            WriteLiteral(@"=""arrow-up-right""></i> arrow-up-right
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
     ...
     ");
            ...
            WriteLiteral(@"m-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i data-feather=""chevron-right""></i> ch");
            WriteLiteral(@"evron-right
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
         ...
         ");
            WriteLiteral(@"           <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                 ");
            WriteLiteral(@"       <i data-feather=""cloud-rain""></i> cloud-rain
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"   <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                       ");
            WriteLiteral(@" <i data-feather=""corner-left-down""></i> corner-left-down
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <");
            WriteLiteral(@"i data-feather=""cpu""></i> cpu
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i data-f");
            WriteLiteral(@"eather=""dribbble""></i> dribbble
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
 ...
 ");
            WriteLiteral(@"                   </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                 ");
            WriteLiteral(@"       <i data-feather=""folder-plus""></i> folder-plus
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@" <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i data-feather=""hard-dri");
            WriteLiteral(@"ve""></i> hard-drive
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
       ...
       ");
            WriteLiteral(@"             </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i data-feather");
            WriteLiteral(@"=""maximize-2""></i> maximize-2
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i data-feather=""monito");
            WriteLiteral(@"r""></i> monitor
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
   ...
   ");
            WriteLiteral(@"                 <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                     ");
            WriteLiteral(@"   <i data-feather=""plus-circle""></i> plus-circle
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"/i> rss
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
             ");
            WriteLiteral(@"           <i data-feather=""share-2""></i> share-2
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i data");
            WriteLiteral(@"-feather=""smartphone""></i> smartphone
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"iv>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
         ");
            WriteLiteral(@"               <i data-feather=""trash""></i> trash
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"   </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i data-feather=""");
            WriteLiteral(@"x-octagon""></i> x-octagon
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
 ");
            WriteLiteral(@"                       <i data-feather=""zoom-out""></i> zoom-out
                    </div>
                </div>
                <!-- end row -->
        ...
        <div class=""card"">
            ...
            <div class=""card-body pt-0"">
                <div class=""row icon-demo-content"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                     ");
            WriteLiteral(@"   <i data-feather=""airplay"" class=""icon-sm""></i> airplay
                    </div>
...
<div class=""row"">
        ...
        <div class=""card"">
            ...
            <div class=""card-body pt-0"">
                ...
                <div class=""row icon-demo-content"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
  ");
            WriteLiteral(@"                      <i data-feather=""alert-triangle"" class=""icon-dual-info""></i> alert-triangle
                    </div>
  ...
  ");
            ...
            DefineSection("scripts", async() => {
                WriteLiteral("\r\n    \r\n    <!-- App js -->\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8acd3bacb7c7debf6de0f3674afad5ecc26b283755908", async() => {
                }
                );
