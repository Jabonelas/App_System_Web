#pragma checksum "C:\Projects\raju\velzon\Velzon_asp_core\Velzon\Velzon\Views\Icons\Boxicons.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e69f79c937867e9dc85e787392db763dc5000edf"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e69f79c937867e9dc85e787392db763dc5000edf", @"/Views/Icons/Boxicons.cshtml")]
    ...
    public class Views_Icons_Boxicons : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Projects\raju\velzon\Velzon_asp_core\Velzon\Velzon\Views\Icons\Boxicons.cshtml"
...
<div class=""row"">
    <div class=""col-12"">
        <div class=""card"">
            ...
            WriteLiteral(@"bx bx-male-female
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
           ...
           ");
            ...
            WriteLiteral(@"v class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i ");
            WriteLiteral(@"class=""bx bx-expand-horizontal""></i> bx bx-expand-horizontal
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=");
            WriteLiteral(@"""bx bx-podcast""></i> bx bx-podcast
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
  ...
  ");
            ...
            WriteLiteral(@"=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bx-tr");
            WriteLiteral(@"ansfer-alt""></i> bx bx-transfer-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@" class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
      ");
            WriteLiteral(@"                  <i class=""bx bx-square-rounded""></i> bx bx-square-rounded
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bx-buil");
            WriteLiteral(@"ding-house""></i> bx bx-building-house
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bx-me");
            WriteLiteral(@"ssage-alt-dots""></i> bx bx-message-alt-dots
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
 ...
 ");
            ...
            WriteLiteral(@"l-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                     ");
            WriteLiteral(@"   <i class=""bx bx-sort-a-z""></i> bx bx-sort-a-z
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"        <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ");
            WriteLiteral(@"            <i class=""bx bx-spa""></i> bx bx-spa
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
       ...
       ");
            ...
            WriteLiteral(@"  <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ");
            WriteLiteral(@"    <i class=""bx bx-smile""></i> bx bx-smile
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
         ...
         ");
            ...
            WriteLiteral(@"""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
 ");
            WriteLiteral(@"                       <i class=""bx bx-bell-plus""></i> bx bx-bell-plus
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
        ...
        ");
          ...
          ");
            ...
            WriteLiteral(@"g-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class");
            WriteLiteral(@"=""bx bx-image""></i> bx bx-image
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bx-left-down-arrow-circle""></i> b");
            WriteLiteral(@"x bx-left-down-arrow-circle
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
 ...
 ");
            ...
            WriteLiteral(@"-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx");
            WriteLiteral(@" bx-time""></i> bx bx-time
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"/i> bx bx-vertical-center
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i ");
            WriteLiteral(@"class=""bx bx-bookmark-plus""></i> bx bx-bookmark-plus
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
  ...
  ");
            WriteLiteral(@"                      <i class=""bx bx-compass""></i> bx bx-compass
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bx-do");
            WriteLiteral(@"ts-horizontal""></i> bx bx-dots-horizontal
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"        <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ");
            WriteLiteral(@"    <i class=""bx bx-spreadsheet""></i> bx bx-spreadsheet
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"</div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
  ");
            WriteLiteral(@"                      <i class=""bx bx-cloud-light-rain""></i> bx bx-cloud-light-rain
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""");
            WriteLiteral(@"bx bx-credit-card""></i> bx bx-credit-card
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"       <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
               ");
            WriteLiteral(@"         <i class=""bx bx-git-merge""></i> bx bx-git-merge
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bx-home-alt""></i> bx");
            WriteLiteral(@" bx-home-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
    ...
    ");
            WriteLiteral(@"                <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ");
            WriteLiteral(@"    <i class=""bx bx-paragraph""></i> bx bx-paragraph
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
         ...
         ");
            ...
            WriteLiteral(@"i> bx bx-down-arrow
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
         ...
         ");
            WriteLiteral(@"           <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i cl");
            WriteLiteral(@"ass=""bx bx-reply""></i> bx bx-reply
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class");
            WriteLiteral(@"=""bx bx-ruler""></i> bx bx-ruler
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bx-phone-outgoing""></i> b");
            WriteLiteral(@"x bx-phone-outgoing
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
   ...
   ");
     ...
     ");
            ...
            WriteLiteral(@"xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                  ");
            WriteLiteral(@"      <i class=""bx bx-trash-alt""></i> bx bx-trash-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
     ...
     ");
            ...
            WriteLiteral(@"class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i ");
            WriteLiteral(@"class=""bx bx-meh""></i> bx bx-meh
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                      ");
            WriteLiteral(@"  <i class=""bx bx-train""></i> bx bx-train
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
         ...
         ");
            WriteLiteral(@"           <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
   ");
            WriteLiteral(@"                     <i class=""bx bx-wind""></i> bx bx-wind
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@" bx bx-strikethrough
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@""">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
          ");
            WriteLiteral(@"              <i class=""bx bx-grid-small""></i> bx bx-grid-small
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
       ...
       ");
            ...
            WriteLiteral(@"iv class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i c");
            WriteLiteral(@"lass=""bx bx-coffee-togo""></i> bx bx-coffee-togo
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bx-info-square""></i> bx");
            WriteLiteral(@" bx-info-square
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
 ...
 ");
            ...
            WriteLiteral(@"ir""></i> bx bx-chair
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bx-camera-movie""></i> bx");
            WriteLiteral(@" bx-camera-movie
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                     ");
            WriteLiteral(@"   <i class=""bx bx-caret-up-square""></i> bx bx-caret-up-square
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"s=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx ");
            WriteLiteral(@"bx-meteor""></i> bx bx-meteor
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bx-message-alt-err");
            WriteLiteral(@"or""></i> bx bx-message-alt-error
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
     ");
            WriteLiteral(@"                   <i class=""bx bx-message-rounded-error""></i> bx bx-message-rounded-error
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
         ...
         ");
            ...
            WriteLiteral(@"/div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bx-message-sq");
            WriteLiteral(@"uare-edit""></i> bx bx-message-square-edit
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                  ");
            WriteLiteral(@"      <i class=""bx bx-comment-edit""></i> bx bx-comment-edit
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i");
            WriteLiteral(@" class=""bx bx-door-open""></i> bx bx-door-open
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bx-");
            WriteLiteral(@"category""></i> bx bx-category
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bx-movie-");
            WriteLiteral(@"play""></i> bx bx-movie-play
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i ");
            WriteLiteral(@"class=""bx bxs-circle-three-quarter""></i> bx bxs-circle-three-quarter
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-");
            WriteLiteral(@"leaf""></i> bx bxs-leaf
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
          ...
          ");
            ...
            WriteLiteral(@"sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
    ");
            WriteLiteral(@"                    <i class=""bx bxs-quote-single-right""></i> bx bxs-quote-single-right
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"ass=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
       ");
            WriteLiteral(@"                 <i class=""bx bxs-hourglass-top""></i> bx bxs-hourglass-top
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i cl");
            WriteLiteral(@"ass=""bx bxs-cuboid""></i> bx bxs-cuboid
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-log-");
            WriteLiteral(@"out-circle""></i> bx bxs-log-out-circle
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"></i> bx bxs-message-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-palette""></i> bx b");
            WriteLiteral(@"xs-palette
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
    ...
    ");
            WriteLiteral(@"                <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-left-top-arrow-circle""></i> bx bxs-left-top-");
            WriteLiteral(@"arrow-circle
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-skip-n");
            WriteLiteral(@"ext-circle""></i> bx bxs-skip-next-circle
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
      ...
      ");
            ...
            WriteLiteral(@"xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
              ");
            WriteLiteral(@"          <i class=""bx bxs-bookmark-minus""></i> bx bxs-bookmark-minus
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
    ");
            WriteLiteral(@"                    <i class=""bx bxs-calendar-x""></i> bx bxs-calendar-x
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
          ");
            WriteLiteral(@"              <i class=""bx bxs-fast-forward-circle""></i> bx bxs-fast-forward-circle
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-add-to-qu");
            WriteLiteral(@"eue""></i> bx bxs-add-to-queue
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"v class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
     ");
            WriteLiteral(@"                   <i class=""bx bxs-business""></i> bx bxs-business
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"ss=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                  ");
            WriteLiteral(@"      <i class=""bx bxs-upside-down""></i> bx bxs-upside-down
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-alarm-off""></i> bx ");
            WriteLiteral(@"bxs-alarm-off
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
         ...
         ");
            ...
            WriteLiteral(@"class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                       ");
            WriteLiteral(@" <i class=""bx bxs-bookmark-plus""></i> bx bxs-bookmark-plus
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-buil");
            WriteLiteral(@"ding""></i> bx bxs-building
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"        <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
    ");
            WriteLiteral(@"                    <i class=""bx bxs-coffee""></i> bx bxs-coffee
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
       ...
       ");
            ...
            WriteLiteral(@"
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-file-ima");
            WriteLiteral(@"ge""></i> bx bxs-file-image
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
        ...
        ");
            WriteLiteral(@"            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i cla");
            WriteLiteral(@"ss=""bx bxs-hot""></i> bx bxs-hot
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
         ...
         ");
            ...
            WriteLiteral(@"ol-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-paper-plane""></i> bx");
            WriteLiteral(@" bxs-paper-plane
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                  ");
            WriteLiteral(@"      <i class=""bx bxs-rename""></i> bx bxs-rename
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-select-multiple""></i> bx ");
            WriteLiteral(@"bxs-select-multiple
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
 ...
 ");
            WriteLiteral(@"                   <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
   ");
            WriteLiteral(@"                     <i class=""bx bxs-t-shirt""></i> bx bxs-t-shirt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-toggle-left""></i> bx bxs");
            WriteLiteral(@"-toggle-left
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"l-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        ");
            WriteLiteral(@"<i class=""bx bxs-volume-mute""></i> bx bxs-volume-mute
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
           ...
           ");
            ...
            WriteLiteral(@"-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs");
            WriteLiteral(@"-dollar-circle""></i> bx bxs-dollar-circle
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-minus-square""></i> bx");
            WriteLiteral(@" bxs-minus-square
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
       ...
       ");
            ...
            WriteLiteral(@"lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
 ");
            WriteLiteral(@"                       <i class=""bx bxs-capsule""></i> bx bxs-capsule
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"lightning""></i> bx bxs-cloud-lightning
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
          ");
            WriteLiteral(@"              <i class=""bx bxs-car-wash""></i> bx bxs-car-wash
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-d");
            WriteLiteral(@"ryer""></i> bx bxs-dryer
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"m-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-stic");
            WriteLiteral(@"ker""></i> bx bxs-sticker
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-chevrons-left""></i> bx b");
            WriteLiteral(@"xs-chevrons-left
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"bx bxs-chevron-right
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"alt""></i> bx bxs-right-arrow-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
  ...
  ");
            ...
            WriteLiteral(@"ss=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-chevron-up-square""></i> bx");
            WriteLiteral(@" bxs-chevron-up-square
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-bullseye""></i> b");
            WriteLiteral(@"x bxs-bullseye
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-message-alt-error""><");
            WriteLiteral(@"/i> bx bxs-message-alt-error
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-message-rounded-detail""></i> bx bxs-message-rounded");
            WriteLiteral(@"-detail
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxs-message-add""></i> bx bxs-mess");
            WriteLiteral(@"age-add
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
          ");
            WriteLiteral(@"              <i class=""bx bxs-message-square-edit""></i> bx bxs-message-square-edit
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
      ");
            WriteLiteral(@"                  <i class=""bx bxs-bookmark-alt""></i> bx bxs-bookmark-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                  ");
            WriteLiteral(@"      <i class=""bx bxs-movie-play""></i> bx bxs-movie-play
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"      <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        ");
            WriteLiteral(@"<i class=""bx bxl-flask""></i> bx bxl-flask
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
 ...
 ");
            ...
            WriteLiteral(@"lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
   ");
            WriteLiteral(@"                     <i class=""bx bxl-imdb""></i> bx bxl-imdb
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"ss=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ");
            WriteLiteral(@"    <i class=""bx bxl-dribbble""></i> bx bxl-dribbble
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxl-google-plus-c");
            WriteLiteral(@"ircle""></i> bx bxl-google-plus-circle
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxl-slack""></i> bx bxl-slac");
            WriteLiteral(@"k
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i cl");
            WriteLiteral(@"ass=""bx bxl-500px""></i> bx bxl-500px
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"lass=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                      ");
            WriteLiteral(@"  <i class=""bx bxl-yelp""></i> bx bxl-yelp
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
       ...
       ");
            ...
            WriteLiteral(@"-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=");
            WriteLiteral(@"""bx bxl-paypal""></i> bx bxl-paypal
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
        ...
        ");
            ...
            WriteLiteral(@"-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class");
            WriteLiteral(@"=""bx bxl-spotify""></i> bx bxl-spotify
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""bx bxl-whatsapp-square""></i> bx bxl-whatsapp-squ");
            WriteLiteral(@"are
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
...
");
            DefineSection("scripts", async() => {
                WriteLiteral("\r\n    \r\n    <!-- App js -->\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e69f79c937867e9dc85e787392db763dc5000edf279046", async() => {
                }
                );
