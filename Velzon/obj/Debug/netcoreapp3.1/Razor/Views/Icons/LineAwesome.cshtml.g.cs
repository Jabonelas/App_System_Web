#pragma checksum "C:\Projects\raju\velzon\Velzon_asp_core\Velzon\Velzon\Views\Icons\LineAwesome.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "33ad42264b94526b71c5bb974cb0abbc49485658"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"33ad42264b94526b71c5bb974cb0abbc49485658", @"/Views/Icons/LineAwesome.cshtml")]
    ...
    public class Views_Icons_LineAwesome : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Projects\raju\velzon\Velzon_asp_core\Velzon\Velzon\Views\Icons\LineAwesome.cshtml"
...
<div class=""row icon-demo-content"">
        ...
        <div class=""card"">
            ...
            <div class=""card-body"">
                ...
                <div class=""row icon-demo-content"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-assistive-listening-systems""></i> las la");
            WriteLiteral(@"-assistive-listening-systems
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-low-vision""></i> las la-low-");
            WriteLiteral(@"vision
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-wheelchair""></i> las la-wheelchai");
            WriteLiteral(@"r
                    </div>
                </div>
                <!-- end row -->
            ...
            WriteLiteral(@"""></i> las la-exclamation-triangle
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                ...
                <div class=""row icon-demo-content"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i cla");
            WriteLiteral(@"ss=""las la-crow""></i> las la-crow
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
         ...
         ");
            WriteLiteral(@"           <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
             ");
            WriteLiteral(@"           <i class=""las la-paw""></i> las la-paw
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"g-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-arrow-circle-right""></i> las la-arrow-circl");
    ...
    ");
            ...
            WriteLiteral(@" las la-chart-line
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
     ");
            WriteLiteral(@"                   <i class=""las la-chevron-left""></i> las la-chevron-left
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
     ...
     ");
            WriteLiteral(@"               </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""la");
            WriteLiteral(@"s la-long-arrow-alt-up""></i> las la-long-arrow-alt-up
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
 ...
 ");
            WriteLiteral(@"                   <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-sort-numeric-down""></i> las la-so");
            WriteLiteral(@"rt-numeric-down
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"></i> las la-sync-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"ss=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
      ");
            WriteLiteral(@"                  <i class=""las la-redo""></i> las la-redo
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-redo-alt""></i> las la-redo-alt
                    </div>
            ...
            WriteLiteral(@"v class=""col-xl-3 col-lg-4 col-sm-6"">
                ...
                <h6 class=""text-upp");
            WriteLiteral(@"ercase text-muted fw-semibold mt-4"">Automotive</h6>
                <div class=""row icon-demo-content"">
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-car-alt""><");
            WriteLiteral(@"/i> las la-car-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
    ...
    ");
            ...
            WriteLiteral(@" class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ");
            WriteLiteral(@"    <i class=""las la-wine-bottle""></i> las la-wine-bottle
                    </div>
                </div>
   ...
   ");
            ...
            WriteLiteral(@"<div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
         ");
            WriteLiteral(@"               <i class=""lab la-amilia""></i> lab la-amilia
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-app-stor");
            WriteLiteral(@"e-ios""></i> lab la-app-store-ios
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
              ");
            WriteLiteral(@"          <i class=""lab la-blackberry""></i> lab la-blackberry
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-b");
            WriteLiteral(@"uy-n-large""></i> lab la-buy-n-large
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-chromecast""></i> la");
            WriteLiteral(@"b la-chromecast
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
       ...
       ");
            WriteLiteral(@"             </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
         ");
            WriteLiteral(@"               <i class=""lab la-creative-commons-pd-alt""></i>lab la-creative-commons-pd-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-creative-commons-share"">");
            WriteLiteral(@"</i>lab la-creative-commons-share
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-delicious""></i> lab la");
            ...
            WriteLiteral(@"iv class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ");
            WriteLiteral(@"            <i class=""lab la-draft2digital""></i> lab la-draft2digital
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-ear");
            WriteLiteral(@"lybirds""></i> lab la-earlybirds
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"   <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
         ");
            WriteLiteral(@"               <i class=""lab la-facebook-f""></i> lab la-facebook-k
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=");
            WriteLiteral(@"""lab la-firefox""></i> lab la-firefox
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"ly
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-fort-awesome""></i> lab");
            WriteLiteral(@" la-fort-awesome
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
...
");
            ...
            WriteLiteral(@"         <i class=""lab la-gofore""></i> lab la-gofore
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-google-p");
            WriteLiteral(@"lus""></i>lab la-google-plus
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
    ...
    ");
            ...
            WriteLiteral(@"
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
      ");
            WriteLiteral(@"                  <i class=""lab la-imdb""></i>  lab la-imdb
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-i");
            WriteLiteral(@"tch-io""></i> lab la-itch-io
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
           ...
           ");
            WriteLiteral(@"         <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
               ");
            WriteLiteral(@"         <i class=""lab la-keycdn""></i> lab la-keycdn
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-lastfm-square""></i>");
            WriteLiteral(@" lab la-lastfm-square
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
           ...
           ");
            WriteLiteral(@"         <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
   ");
            WriteLiteral(@"                     <i class=""lab la-mastodon""></i> lab la-mastodon
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
  ...
  ");
        ...
        ");
            ...
            WriteLiteral(@"4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
          ");
            WriteLiteral(@"              <i class=""lab la-phoenix-squadron""></i> lab la-phoenix-squadron
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ");
            WriteLiteral(@"            <i class=""lab la-pinterest""></i> lab la-pinterest
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""");
            WriteLiteral(@"lab la-qq""></i> lab la-qq
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
           ...
           ");
            ...
            WriteLiteral(@"        <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
              ");
            WriteLiteral(@"          <i class=""lab la-slack-hash""></i> lab la-slack-has
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        ");
            WriteLiteral(@"<i class=""lab la-speakap""></i> lab la-speakap
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class");
            WriteLiteral(@"=""lab la-staylinked""></i> lab la-staylinked
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""la");
            WriteLiteral(@"b la-superpowers""></i> lab la-superpowers
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
   ...
   ");
            ...
            WriteLiteral(@"ss=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i ");
            WriteLiteral(@"class=""lab la-uniregistry""></i> lab la-uniregistry
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
...
");
       ...
       ");
            ...
            WriteLiteral(@"-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
             ");
            WriteLiteral(@"           <i class=""lab la-yahoo""></i> lab la-yahoo
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
        ...
        ");
            WriteLiteral(@"            <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
    ");
            WriteLiteral(@"                    <i class=""las la-hospital""></i> las la-hospital
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-kaaba");
            WriteLiteral(@"""></i> las la-kaaba
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
       ...
       ");
            WriteLiteral(@"         <h6 class=""text-uppercase text-muted fw-semibold mt-4"">Business</h6>
                <div class=""row icon-demo-content"">
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
          ");
            WriteLiteral(@"              <i class=""las la-chart-area""></i> las la-chart-area
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-coffee""></");
            WriteLiteral(@"i> las la-coffee
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"ss=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
           ");
            WriteLiteral(@"             <i class=""las la-file-alt""></i> las la-file-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-g");
            WriteLiteral(@"lobe""></i> las la-globe
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
         ...
         ");
            ...
            WriteLiteral(@"class=""col-xl-3 col-lg-4 col-sm-6"">
                ...
                <div class=""row icon-demo-content"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
  ");
            WriteLiteral(@"                      <i class=""las la-compass""></i>  las la-compass
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@">
                ...
                <div class=""row icon-demo-content"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
  ");
            WriteLiteral(@"                      <i class=""las la-hand-holding-heart""></i> las la-hand-holding-heart
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
              ");
            WriteLiteral(@"          <i class=""las la-parachute-box""></i> las la-parachute-box
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                ...
                <div class=""row icon-demo-content"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-comment-alt""></");
            WriteLiteral(@"i> las la-comment-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
   ...
   ");
            ...
            WriteLiteral(@"-xl-3 col-lg-4 col-sm-6"">
                ...
                <div class=""row icon-demo-content"">
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class");
            WriteLiteral(@"=""las la-chess""></i> las la-chess
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-chess-queen"">");
            WriteLiteral(@"</i> las la-chess-queen
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
      ...
      ");
            ...
            WriteLiteral(@"lass=""col-xl-3 col-lg-4 col-sm-6"">
                ...
                <h6 class=""text-uppercase text-muted fw-semibold m");
            WriteLiteral(@"t-4"">Clothing</h6>
                <div class=""row icon-demo-content"">
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-sho");
            WriteLiteral(@"e-prints""></i> las la-shoe-prints
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
 ...
 ");
            ...
            WriteLiteral(@"       <i class=""las la-file-alt""></i> las la-file-alt
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-keyb");
            WriteLiteral(@"oard""></i> las la-keyboard
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
      ...
      ");
            WriteLiteral(@"              </div>
                ...
                <div class=""row icon-demo-content"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las ");
            WriteLiteral(@"la-assistive-listening-systems""></i> las la-assistive-listening-systems
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-broadcast-tow");
            WriteLiteral(@"er""></i> las la-broadcast-tower
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-bullhorn""></i> las la-bullhorn
                    </div>
           ...
           ");
            WriteLiteral(@"         <div class=""col-xl-3 col-lg-4 col-sm-6"">
                ...
                <div class=""row icon-demo-content"">
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                ");
            WriteLiteral(@"        <i class=""las la-database""></i> las la-database
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-keyboard""></i> las la-keyboar");
            WriteLiteral(@"d
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"ass=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                 ");
            WriteLiteral(@"       <i class=""las la-sd-card""></i> las la-sd-card
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"-6"">
                ...
                <div class=""row icon-demo-content"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-euro-sign");
            WriteLiteral(@"""></i> las la-euro-sign
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"     </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-ruble-sign""></i> las la-ruble-sig");
            WriteLiteral(@"n
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
    ...
    ");
            WriteLiteral(@"                    <i class=""las la-clone""></i> las la-clone
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-drafting-compass""></i> las la-draftin");
            WriteLiteral(@"g-compass
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"       <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
   ");
            WriteLiteral(@"                     <i class=""las la-marker""></i> las la-marker
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                     ");
            WriteLiteral(@"   <i class=""las la-paste""></i> las la-paste
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-pen""></i> las la-pen
                    </div>
...
");
            ...
            WriteLiteral(@" col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=");
            WriteLiteral(@"""las la-cut""></i> las la-cut
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-edit""></i> las la-edit
                    </div>
            ...
            WriteLiteral(@"  <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ");
            WriteLiteral(@"            <i class=""las la-link""></i> las la-link
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
           ...
           ");
            ...
            WriteLiteral(@"l-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
             ");
            WriteLiteral(@"           <i class=""las la-reply-all""></i> las la-reply-all
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-screwdriver""></i> las la-screwdriver
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las l");
            WriteLiteral(@"a-sync""></i> las la-sync
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-text-width""></i> las la-text-width
                    </div>
            ...
            WriteLiteral(@"i> las la-bell
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-graduation-cap""></i> las l");
            WriteLiteral(@"a-graduation-cap
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-laptop-code""></i> las la-laptop-code
                    </div>
            ...
            WriteLiteral(@"ol-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <");
            WriteLiteral(@"i class=""las la-grin-hearts""></i> las la-grin-hearts
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i ");
            WriteLiteral(@"class=""las la-grin-tongue-squint""></i> las la-grin-tongue-squint
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i ");
            WriteLiteral(@"class=""las la-laugh""></i> las la-laugh
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-smile-beam""></i> las la-sm");
            WriteLiteral(@"ile-beam
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
        ...
        ");
            ...
            WriteLiteral(@"xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ");
            WriteLiteral(@"    <i class=""las la-seedling""></i> las la-seedling
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ");
            WriteLiteral(@"            <i class=""las la-file-video""></i> las la-file-video
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"""></i> las la-book
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-comments-dollar""></i> las la-comment");
            WriteLiteral(@"s-dollar
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-landmark""></i> las l");
            WriteLiteral(@"a-landmark
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-money-bill""></i> las la-money-bill
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-money-ch");
            WriteLiteral(@"eck-alt""></i> las la-money-check-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <");
            WriteLiteral(@"i class=""las la-hamburger""></i> las la-hamburger
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-seedling""></i> las la-seed");
            WriteLiteral(@"ling
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"ass=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
     ");
            WriteLiteral(@"                   <i class=""las la-dice-two""></i> las la-dice-two
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-gamepad""></i> las la-gamepad
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-puzzle-piece""></i> l");
            WriteLiteral(@"as la-puzzle-piece
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"-4 col-sm-6"">
                ...
                <div class=""row icon-demo-content"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""");
            WriteLiteral(@"las la-crow""></i> las la-crow
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-ghost""></i> las la-ghost
                    </div>
...
");
            WriteLiteral(@"                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-hand-point-left""></i> las la-h");
            WriteLiteral(@"and-point-left
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-hand-point-right""></i> las la-hand-point-right
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-hand-spock""></i>");
            WriteLiteral(@" las la-hand-spock
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
        ...
        ");
            ...
            WriteLiteral(@" col-lg-4 col-sm-6"">
                ...
                <div class=""row icon-demo-content"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                     ");
            WriteLiteral(@"   <i class=""las la-gifts""></i> las la-gifts
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-glass-cheers""></i> las la-glass-cheers
                    </div>
                ...
                <div");
            WriteLiteral(@" class=""row icon-demo-content"">
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-baby-carriage""></i> las la-baby-carriage
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"s=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
   ");
            WriteLiteral(@"                     <i class=""las la-dumbbell""></i> las la-dumbbell
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-glass-martini""></i> las la-glass-martini
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i cl");
            WriteLiteral(@"ass=""las la-key""></i> las la-key
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-snowflake""></i> las la-snowfla");
            WriteLiteral(@"ke
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"class=""col-xl-3 col-lg-4 col-sm-6"">
                ...
                <div class=""row icon-demo-content"">
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i cl");
            WriteLiteral(@"ass=""las la-adjust""></i> las la-adjust
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
          ...
          ");
            WriteLiteral(@"          <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
        ");
            WriteLiteral(@"                <i class=""las la-portrait""></i> las la-portrait
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
 ...
 ");
            ...
            WriteLiteral(@"6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                 ");
            WriteLiteral(@"       <i class=""las la-calendar-minus""></i> las la-calendar-minus
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-calendar-plus""></i> las la-calendar-plus
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                     ");
            WriteLiteral(@"   <i class=""las la-check-double""></i> las la-check-double
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las l");
            WriteLiteral(@"a-cloud-upload-alt""></i> las la-cloud-upload-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-coffee""></i> las la-coffee
                    </div>
        ...
        ");
            ...
            WriteLiteral(@"ol-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
              ");
            WriteLiteral(@"          <i class=""las la-flag-checkered""></i> las la-flag-checkered
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-folder""></i> las la-folder
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la");
            WriteLiteral(@"-grip-lines""></i> las la-grip-lines
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-home""></i> las la-h");
            WriteLiteral(@"ome
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-i-cursor""></i> las la-i-cursor
            ...
            WriteLiteral(@"
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-penc");
            WriteLiteral(@"il-alt""></i> las la-pencil-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"lass=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                      ");
            WriteLiteral(@"  <i class=""las la-search""></i> las la-search
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"-square""></i> las la-share-square
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-shield-alt""></i> las la-shield-alt
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-sliders-h""></i> las la-sliders-");
            WriteLiteral(@"h
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-smile""></i> las la-smile
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-sort-alpha-up-alt""></i> las la-sort-alpha-u");
            WriteLiteral(@"p-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-sort-amount-down""></i> las la-sort-amount-down
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las ");
            WriteLiteral(@"la-star""></i> las la-star
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"l-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
         ");
            WriteLiteral(@"               <i class=""las la-user""></i> las la-user
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-");
            WriteLiteral(@"volume-up""></i> las la-volume-up
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-wifi""></i> las la-wifi
                    </div>
 ...
 ");
            WriteLiteral(@"                       <i class=""las la-balance-scale-left""></i> las la-balance-scale-left
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las l");
            WriteLiteral(@"a-bell-slash""></i> las la-bell-slash
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-bicycle""></i> las la-bicycle
                    </div>
            ...
            WriteLiteral(@"            <i class=""las la-fire""></i> las la-fire
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-gamepad"">");
            WriteLiteral(@"</i> las la-gamepad
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"m-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-layer-group""><");
            WriteLiteral(@"/i> las la-layer-group
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-leaf""></i> las la-leaf
                    </div>
            ...
            WriteLiteral(@"ol-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
              ");
            WriteLiteral(@"          <i class=""las la-newspaper""></i> las la-newspaper
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-phone-square-alt""></i> la");
            WriteLiteral(@"s la-phone-square-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-phone-volume""></i> las la-phone-volume
                    </div>
         ...
         ");
            ...
            WriteLiteral(@"       <i class=""las la-search-minus""></i> las la-search-minus
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i cl");
            WriteLiteral(@"ass=""las la-shopping-cart""></i> las la-shopping-cart
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-shower""></i> las la-shower
                    </div>
    ...
    ");
            ...
            WriteLiteral(@"=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-tty""></i> l");
            WriteLiteral(@"as la-tty
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"l-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i ");
            WriteLiteral(@"class=""las la-wind""></i> las la-wind
                    </div>
                </div>
                ...
                <div class=""row icon-demo-content"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        3
                        <i class=""las la-comments-d");
            WriteLiteral(@"ollar""></i> las la-comments-dollar
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-poll-h""></i> las");
            WriteLiteral(@" la-poll-h
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
         ...
         ");
            ...
            WriteLiteral(@"-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""");
            WriteLiteral(@"las la-burn""></i> las la-burn
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-diagnoses""></i> las la-di");
            WriteLiteral(@"agnoses
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
   ...
   ");
            ...
            WriteLiteral(@"3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i cl");
            WriteLiteral(@"ass=""las la-user-md""></i> las la-user-md
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"sm-6"">
                ...
                <h6 class=""text-uppercase text-muted fw-semibold mt-");
            WriteLiteral(@"4"">Music</h6>
                <div class=""row icon-demo-content"">
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-headphones-alt""></i> las la-head");
            WriteLiteral(@"phones-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-microphone""></i> las la-microphone
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-napster""></i> la");
            WriteLiteral(@"b la-napster
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-play""></i> las la-play
                    </div>
            ...
            WriteLiteral(@"div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las");
            WriteLiteral(@" la-birthday-cake""></i> las la-birthday-cake
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-blender""></i> las la-blender
                    </div>
            ...
            WriteLiteral(@"-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
  ");
            WriteLiteral(@"                      <i class=""las la-car""></i> las la-car
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-carrot""></i> las la-carrot
                    </div>
           ...
           ");
            ...
            WriteLiteral(@"-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-dice-four""></i> las ");
            WriteLiteral(@"la-dice-four
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-dice-one""></i> las la-dice-one
                    </div>
  ...
  ");
          ...
          ");
            ...
            WriteLiteral(@"
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-fire-exti");
            WriteLiteral(@"nguisher""></i> las la-fire-extinguisher
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-flag""></i> las la-flag
                    </div>
            ...
            WriteLiteral(@" <i class=""las la-headphones""></i> las la-headphones
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-highligh");
            WriteLiteral(@"ter""></i> las la-highlighter
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-holly-berry""></i> las la-holly-berry
                    </div>
...
");
            WriteLiteral(@"                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
          ");
            WriteLiteral(@"              <i class=""las la-lemon""></i> las la-lemon
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-life-ring""></i> las la-life-ring
                    </div>
 ...
 ");
            ...
            WriteLiteral(@"/i> las la-paper-plane
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-paperclip""></i> las la-paperclip
                    </div>
            ...
            WriteLiteral(@"iv class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""");
            WriteLiteral(@"las la-rocket""></i> las la-rocket
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-ruler-combined""></i> las la-ruler-combined
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i cla");
            WriteLiteral(@"ss=""las la-save""></i> las la-save
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-school""></i> las la-school
                    </div>
            ...
            WriteLiteral(@"s=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                       ");
            WriteLiteral(@" <i class=""las la-tablet-alt""></i> las la-tablet-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-tachometer-alt""></i> las la-tachometer-alt
                    </div>
...
");
            ...
            WriteLiteral(@"col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-university""></i> las ");
            WriteLiteral(@"la-university
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
 ...
 ");
            ...
            WriteLiteral(@"col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-ama");
            WriteLiteral(@"zon""></i> lab la-amazon
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                 ");
            WriteLiteral(@"       <i class=""lab la-bandcamp""></i> lab la-bandcamp
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-battle-net""></i> lab la-battle-net
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""l");
            WriteLiteral(@"ab la-bitbucket""></i> lab la-bitbucket
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-bity""></i> lab la-bity
                    </div>
        ...
        ");
            ...
            WriteLiteral(@"    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
     ");
            WriteLiteral(@"                   <i class=""lab la-creative-commons-sa""></i> lab la-creative-commons-sa
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-creative-commons-sampling""></i> lab la-creative-commons-sampling
                    </div>
           ...
           ");
            WriteLiteral(@"         <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                     ");
            WriteLiteral(@"   <i class=""lab la-digital-ocean""></i> lab la-digital-ocean
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-discord""></i> lab la-discord
                    </div>
          ...
          ");
            ...
            WriteLiteral(@"></i> lab la-facebook-f
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-facebook-messenger""></i> lab la-facebook-messenger
                    </div>
 ...
 ");
     ...
     ");
            ...
            WriteLiteral(@"       <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
       ");
            WriteLiteral(@"                 <i class=""lab la-gitter""></i> lab la-gitter
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-glide""></i> lab la-glide
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-google""></i> lab la-");
            WriteLiteral(@"google
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-google-drive""></i> lab la-google-drive
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-gratipay""></i> lab l");
            WriteLiteral(@"a-gratipay
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-grav""></i> lab la-grav
                    </div>
  ...
  ");
            ...
            WriteLiteral(@"l-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-internet-explor");
            WriteLiteral(@"er""></i> lab la-internet-explorer
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"/div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
       ");
            WriteLiteral(@"                 <i class=""lab la-jsfiddle""></i> lab la-jsfiddle
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-kaggle""></i> lab la-kaggle
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-korvue");
            WriteLiteral(@"""></i> lab la-korvue
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-laravel""></i> lab la-laravel
                    </div>
          ...
          ");
            WriteLiteral(@"          <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
        ");
            WriteLiteral(@"                <i class=""lab la-mailchimp""></i> lab la-mailchimp
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-mandalorian""></i> lab la-mandalorian
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-medapps""></i> lab l");
            WriteLiteral(@"a-medapps
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-medium""></i> lab la-medium
                    </div>
            ...
            WriteLiteral(@"div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                       ");
            WriteLiteral(@" <i class=""lab la-monero""></i> lab la-monero
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-neos""></i> lab la-neos
                    </div>
            ...
            WriteLiteral(@"          <i class=""lab la-palfed""></i> lab la-palfed
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        ");
            WriteLiteral(@"<i class=""lab la-php""></i> lab la-php
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-pied-piper""></i> lab la-pied-piper
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la");
            WriteLiteral(@"-pinterest-p""></i> lab la-pinterest-p
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-pinterest-square""></i> lab la-pinterest-square
                    </div>
 ...
 ");
            ...
            WriteLiteral(@"</i> lab la-rocketchat
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-rockrms""></i> lab la-rockrms
                    </div>
            ...
            WriteLiteral(@" col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""la");
            WriteLiteral(@"b la-skyatlas""></i> lab la-skyatlas
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-skype""></i> lab la-skype
                    </div>
 ...
 ");
            WriteLiteral(@"                       <i class=""lab la-tumblr""></i> lab la-tumblr
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-ubun");
            WriteLiteral(@"tu""></i> lab la-ubuntu
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-uikit""></i> lab la-uikit
                    </div>
            ...
            WriteLiteral(@"  <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
          ");
            WriteLiteral(@"              <i class=""lab la-viber""></i> lab la-viber
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-vimeo""></i> lab la-vimeo
                    </div>
            ...
            WriteLiteral(@"col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                 ");
            WriteLiteral(@"       <i class=""lab la-wix""></i> lab la-wix
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-wolf-pack-battalion""></i> lab la-wolf-pack-battalion
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <");
            WriteLiteral(@"i class=""lab la-wpforms""></i> lab la-wpforms
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-wpressr""></i> lab la-wpressr
                    </div>
      ...
      ");
            ...
            WriteLiteral(@"6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-cart-arr");
            WriteLiteral(@"ow-down""></i> las la-cart-arrow-down
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""lab la-cc-discove");
            WriteLiteral(@"r""></i> lab la-cc-discover
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
    ...
    ");
        ...
        ");
            WriteLiteral(@"                <i class=""las la-shopping-bag""></i> las la-shopping-bag
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""");
            WriteLiteral(@"las la-tag""></i> las la-tag
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-tags""></i> las la-tags
                    </div>
...
");
            ...
            WriteLiteral(@"ol-lg-4 col-sm-6"">
                ...
                <div class=""row"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-bible""></");
            WriteLiteral(@"i> las la-bible
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-church""></i> las la-church
                    </div>
            ...
            WriteLiteral(@" <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
             ");
            WriteLiteral(@"           <i class=""las la-menorah""></i> las la-menorah
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-mosque""></i> las la-mosque
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-pray""></i> las");
            WriteLiteral(@" la-pray
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-praying-hands""></i> las la-praying-hands
                    </div>
        ...
        ");
            ...
            WriteLiteral(@"-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""l");
            WriteLiteral(@"as la-filter""></i> las la-filter
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-fire""></i> las la-fire
                    </div>
      ...
      ");
            ...
            WriteLiteral(@"lass=""col-xl-3 col-lg-4 col-sm-6"">
                ...
                <div class=""row"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ");
            WriteLiteral(@"            <i class=""lab la-jedi-order""></i> lab la-jedi-order
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-journal-whills""></i> las la-journal-whills
                    </div>
            ...
            WriteLiteral(@"
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-unlock""></i> las la-unlo");
            WriteLiteral(@"ck
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-unlock-alt""></i> las la-unlock-alt
          ...
          ");
            WriteLiteral(@"          <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
        ");
            WriteLiteral(@"                <i class=""las la-folder""></i> las la-folder
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-heart""></i> las la-heart
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-square""></i> las la-squ");
            WriteLiteral(@"are
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-star""></i> las la-star
            ...
            WriteLiteral(@"3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las");
            WriteLiteral(@" la-images""></i> las la-images
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-map-marker""></i> las la-map-marker
                    </div>
      ...
      ");
            ...
            WriteLiteral(@"<div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
");
            WriteLiteral(@"                        <i class=""las la-video""></i> las la-video
                    </div>
                </div>
                ...
                <div class=""row"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-cog""></i> las la-co");
            WriteLiteral(@"g
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
           ...
           ");
            WriteLiteral(@"         <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
         ");
            WriteLiteral(@"               <i class=""las la-stroopwafel""></i> las la-stroopwafel
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-sun""></i> las la-sun
                    </div>
            ...
            WriteLiteral(@""">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-s");
            WriteLiteral(@"eedling""></i> las la-seedling
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-umbrella""></i> las la-umbrella
                    </div>
            ...
            WriteLiteral(@"       </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-calendar-week""></i> las la-calendar-w");
            WriteLiteral(@"eek
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-cart-arrow-down""></i> las la-cart-arrow-down
           ...
           ");
            ...
            WriteLiteral(@"ol-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                   ");
            WriteLiteral(@"     <i class=""las la-map-marker-alt""></i> las la-map-marker-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-microphone""></i> las la-microphone
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
   ");
            WriteLiteral(@"                     <i class=""las la-minus-circle""></i> las la-minus-circle
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-minus-square""></i> las la-minus-square
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=");
            WriteLiteral(@"""las la-plus""></i> las la-plus
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-plus-circle""></i> las la-plus-circle
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-shield-alt""></i> las la-sh");
            WriteLiteral(@"ield-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-shopping-cart""></i> las la-shopping-cart
                    </div>
      ...
      ");
            WriteLiteral(@"              </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-tint-slash""></i> las la-ti");
            WriteLiteral(@"nt-slash
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-toggle-off""></i> las la-toggle-off
                    </div>
          ...
          ");
            ...
            WriteLiteral(@"sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        ");
            WriteLiteral(@"<i class=""las la-dungeon""></i> las la-dungeon
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las ");
            WriteLiteral(@"la-scroll""></i> las la-scroll
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-skull-crossbones""></i> las la-skull-crossbones
                    </div>
  ...
  ");
        ...
        ");
            ...
            WriteLiteral(@"lass=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class");
            WriteLiteral(@"=""las la-id-card-alt""></i> las la-id-card-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-male""></i> las la-male
                    </div>
           ...
           ");
            ...
            WriteLiteral(@"l-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                   ");
            WriteLiteral(@"     <i class=""las la-user-alt""></i> las la-user-alt
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-user-alt-slash""></i> las la-user-alt-slash
                    </div>
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i ");
            WriteLiteral(@"class=""las la-user-cog""></i> las la-user-cog
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-us");
            WriteLiteral(@"er-md""></i> las la-user-md
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-user-shield""></i> las la-user-");
            WriteLiteral(@"shield
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-user-slash""></i> las la-user-slash
      ...
      ");
            WriteLiteral(@"              <div class=""col-xl-3 col-lg-4 col-sm-6"">
                ...
                <div class=""row"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
       ");
            WriteLiteral(@"                 <i class=""las la-cloud-moon""></i> las la-cloud-moon
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
            ...
            WriteLiteral(@"      <div class=""col-xl-3 col-lg-4 col-sm-6"">
                    ...
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
      ");
            WriteLiteral(@"                  <i class=""las la-skiing-nordic""></i> las la-skiing-nordic
                    </div>
                    <div class=""col-xl-3 col-lg-4 col-sm-6"">
                        <i class=""las la-snowboarding""></i> las la-snowboarding
                    </div>
...
");
            DefineSection("scripts", async() => {
                WriteLiteral("\r\n   \r\n    <!-- App js -->\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "33ad42264b94526b71c5bb974cb0abbc49485658520217", async() => {
                }
                );
