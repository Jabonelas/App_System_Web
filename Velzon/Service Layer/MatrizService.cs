...
public class MatrizService
{
    ...
    public MatrizService(CApp_SystemApp_System_BancobancoSQLitedbContext _context)
    {
        context = _context;
    }
    ...
    public IEnumerable<dynamic> BuscarMatriz()
    {

        var matriz = context.tb_matriz
                        .Where(x => x.mt_desat == 0)
                        .Select(x => new { x.id_matriz, x.mt_cnpj, x.mt_desat, x.mt_nomeFant, x.mt_razSoc })
                        .ToList();
