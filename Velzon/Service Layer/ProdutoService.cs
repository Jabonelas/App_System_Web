...
public class ProdutoService
{
    ...
    public ProdutoService(CApp_SystemApp_System_BancobancoSQLitedbContext _context)
    {
        context = _context;
    }

    public void CadastrarProduto(tb_produto _produto)
    {
        _produto.pd_dtCri = DateTime.Now;
        _produto.pd_dtAlt = DateTime.Now;
        _produto.pd_nfeCsosn = 0;
        _produto.pd_nfeProdOrigem = 0;
        _produto.pd_fxEta = 0;
        _produto.pd_especie = 0;
        _produto.pd_proTipo = 0;
        _produto.pd_genero = 0;
        _produto.pd_desat = 0;
